...
VALID_VRAY_CONFIGS: dict[str, set[str]] = {
    ...
    '7': { '2020', '2021', '2022', '2023', '2024', '2025', '2026', '2027' }
}
...
def main() -> None:
    ...
    # remove invalid 3ds Mayx <-> Vray combos
    builder.remove_build_if(
        lambda build: build.options['vraysdk:max_version'] not in VALID_VRAY_CONFIGS[build.options['vraysdk:vray_version']])
